...
// npx hardhat deployBridges --original-networks "goerli,bscTestnet,mumbai" --wrapped-network "coredao-testnet"
...
// npx hardhat deployTestTokens --original-networks "goerli,bscTestnet,mumbai"
...
task("setTrustedRemote", "calls setTrustedRemoteAddress in OriginalTokenBridge on multiple networks and in WrappedTokenBridge on a wrapped token chain", require("./setTrustedRemote"))
	.addParam("originalNetworks", "comma separated list of networks where OriginalTokenBridge contract is deployed")
	.addParam("wrappedNetwork", "name of the network where WrappedTokenBridge is deployed")
// npx hardhat setTrustedRemote --original-networks "goerli,bscTestnet,mumbai" --wrapped-network "coredao-testnet"
...
// npx hardhat registerToken --original-network "bscTestnet" --original-token "0x33BbFdBA6edFA6E7ac7cA5cbf8100867e0c570CF" --wrapped-network "coredao-testnet" --wrapped-token "0x631774c0B3FDB9502b3093a22aD91FA83fEc493e"
...
task("registerTokens", "calls registerToken in OriginalTokenBridge and WrappedTokenBridge", require("./registerTokens"))
 ...
 // npx hardhat registerTokens --original-networks "goerli,bscTestnet,mumbai" --wrapped-network "coredao-testnet" --tokens "WETH,USDC"
...
// npx hardhat transferOwnership --new-owner "0x1b2B4F723e1579db0981d826017E3eaeb77Bb493" --original-networks "goerli,bscTestnet,mumbai" --wrapped-network "coredao-testnet"
